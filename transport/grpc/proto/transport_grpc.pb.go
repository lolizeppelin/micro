...
func (c *transportClient) Stream(ctx context.Context, opts ...grpc.CallOption) (Transport_StreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Transport_ServiceDesc.Streams[0], "/Transport/Stream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *transportClient) Call(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/Transport/Call", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
